 ...
 *
 * Adds additional structs which track peer addresses updates,
 * and overrides the handlers for appropriate connection related hooks
 * to use and manage those structs.
 *
...
static ngx_command_t  ngx_http_upstream_jdomain_commands[] = {
  ...
  {
    ngx_string("refeshed_hostname"),            /**< Directive keyword.*/
...
/**
 * Handler for closing a peer connection.
 *
...
/**
 * Handler for an SSL session being created.
 *
